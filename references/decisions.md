...
### HTML as primary output, not PDF

**Decision:** Final output is static HTML. PDF is not a primary target.
...
- Treat it as a reflowed A4 reading artifact
- Label source locations as “原剧本第 X 页”
- Do not match generated PDF pages to source PDF pages
